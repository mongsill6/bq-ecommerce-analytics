...
echo_header "월간 비즈니스 리포트 (${MONTH})"
echo "기간: ${MONTH_START} ~ ${MONTH_END}"
echo "매출 목표: $(printf "%'d" "$TARGET")원"
echo ""

# ──────────────────────────────────────────────
# 1. 매출 요약 (YoY 비교) → '매출요약' 탭
# ──────────────────────────────────────────────
echo "📊 [1/4] 매출 YoY 비교 조회 중..."
...
echo "  ✅ 재고현황 탭 업데이트 완료 (긴급: ${CRITICAL}개, 주의: ${WARNING}개)"

# ──────────────────────────────────────────────
# 4. 광고 ROAS → '광고성과' 탭
# ──────────────────────────────────────────────
echo "📢 [4/4] 광고 ROAS 조회 중..."
...
echo ""
echo "=== 리포트 생성 완료 ==="
echo "📄 시트: https://docs.google.com/spreadsheets/d/$SPREADSHEET_ID"
echo "📑 탭: 요약 | 매출요약 | 베스트셀러 | 재고현황 | 광고성과"
echo "⏱  생성 시각: $NOW"
